...
assert_equals "$(place_runner_get_timing PLACE_LIVE_CLICK_BURST_DELAY)" "8ms" "place live burst delay fallback"
...
assert_equals "$(place_runner_live_click_burst_delay_ms)" "8" "place live burst delay fallback ms"
...
assert_contains "$plan_output" "burst_delay_ms=8" "place live plan burst delay"
